...
### Текущая архитектура (активная)
- **Frontend**: Next.js + Tailwind CSS + Supabase Auth
- **Backend**: Express API
- **Database**: PostgreSQL
- **Integrations**: MCP (Model Context Protocol) серверы

### Функциональные компоненты (проверены и работают)
- ✅ Hero.tsx - главный экран с CTA кнопками
- ✅ Header.tsx - навигация с кнопками Get Started
- ✅ Features.tsx - секция возможностей с CTA
- ✅ Testimonials.tsx - отзывы с кнопками Get Started
- ✅ pricing.tsx - страница цен с кнопками Get Started
- ✅ sign-in.tsx - страница регистрации с формой и опросами
- ✅ thank-you.tsx - страница благодарности

### User Flow (рабочий)
1. Пользователь нажимает любую кнопку "Get Started" → /sign-in
2. Заполняет форму регистрации (имя, email, размер компании + опросы)
3. Сохранение данных в localStorage
4. Редирект на /thank-you страницу
5. Данные доступны для просмотра и экспорта
